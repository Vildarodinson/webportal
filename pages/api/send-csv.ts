...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  const mailOptions = {
    ...
    subject: 'Your CVS',
    text: 'Here is your CSV attachment.',
    attachments: [
      {
        filename: 'generated.csv', // Specify the filename for the attachment
        content: createReadStream('./uploads/generated.csv'), // Read the CSV from the file path
      },
    ],
  };
