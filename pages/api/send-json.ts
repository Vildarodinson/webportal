...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  const mailOptions = {
    ...
    subject: 'Your JSON',
    text: 'Here is your JSON attachment.',
    attachments: [
      {
        filename: 'generated.json', // Specify the filename for the attachment
        content: createReadStream('./uploads/generated.json'), // Read the json from the file path
      },
    ],
  };
